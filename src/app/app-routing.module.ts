...
const routes: Routes = [
  ...
  {path: 'gestionarCanciones', component: GestionarCancionesComponent},
  {path: 'agregarDiscos', component: AgregarDiscosComponent},
  {path: 'gestionarDiscos', component: GestionarDiscosComponent},
